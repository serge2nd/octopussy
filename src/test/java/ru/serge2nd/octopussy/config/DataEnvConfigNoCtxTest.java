...
class DataEnvConfigNoCtxTest {
    ...
    void testNewJpaEnvironment() {
        ...
        when(providerMock.getTransactionManager(same(emf))).thenReturn(tm);
        // AND
        ...
        assertSame(tm, result.getTransactionManager(), "transaction manager does not match"));
    }
    ...
    void testGetQueryAdapter() throws Exception {
        ...
        assertSame(ToListResultTransformer.INSTANCE, getField(target, "transformer"), "wrong result transformer"));
    }
}